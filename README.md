...
> **About the application.** [Dealsbe](https://dealsbe.com/) is a curated
> directory of AI tools for real work: it catalogs AI products across categories
> (writing, design, coding, video, research, marketing) and lets founders,
> marketers, developers and creators search them, save favorites and follow new
> additions. In this project Dealsbe is a Django app packaged as
> `charts/django-app`; the database this module provisions is where it would keep
> its tool catalog, user accounts, favorites and activity feed.
...
**This README covers the three things the task asks for:** a
[usage example](#using-the-module) (`module "rds" { ... }`), a
[description of every variable](#inputs), and
[how to change the DB type, engine, instance class and more](#how-to-change-things).
